...
exportMenu.addEventListener('toggle',e=>{const open=e.newState==='open';exportTrigger.setAttribute('aria-expanded',String(open));if(open){positionExportMenu();exportMenu.querySelector('button').focus();}});
